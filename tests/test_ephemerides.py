...
class TestAstroDog(unittest.TestCase):
  ...
  def test_read_prn_data(self):
    ...
    def get_single_measurement(t):
      return [(EphemerisType.ULTRA_RAPID_ORBIT, GPSTime(0,0), "filename.filetype"), GPSTime(week=2177, tow=172800.0 + t),
                                                                    -22481344.405, -14485178.376, -554329.557, 0.000555129133]
