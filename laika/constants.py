...
# GLONASS system parameters (old convention)
GLONASS_L1 = 1.602e9
...
# Galileo system parameters (has additional frequencies on E6), source RINEX 2.11 document
